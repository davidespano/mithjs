...
import TaskTree from './task/TaskTreeComponent.js'
...
function test2() {
    ...
    let completed = Task.enable(model, Immutable.Seq.of());
    console.log(completed.toJSON())

    completed = Task.complete(completed, utils.byId(completed, 'MARK_DELETED'));
    console.log(completed.toJSON())
    return completed;
}
